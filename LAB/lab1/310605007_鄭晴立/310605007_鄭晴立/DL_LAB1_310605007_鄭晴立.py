...
# Load Data
train_load = np.loadtxt('./data/train.csv',delimiter=',',dtype="int",max_rows=10000)
test_data = np.loadtxt('./data/test.csv',delimiter=',',dtype="int",max_rows=10000)
...
for epoch in range(1, EPOCH+1):
    ...
    for it in range(train_batch_num):
        ...
        net.backward(pred,train_label_onehot[it*Batch_size:(it+1)*Batch_size] )
