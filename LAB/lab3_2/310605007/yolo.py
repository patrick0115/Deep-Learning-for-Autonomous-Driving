...
#         "model_path"        : 'model_data/yolov4_mobilenet_v3_map75.30.pth',
        # "model_path"        : 'logs/Epoch62-Total_Loss2.0718-Val_Loss1.9604.pth',
        "model_path"        : 'logs/Epoch300-Total_Loss1.4358-Val_Loss1.9964.pth',        
...
#             print(self.class_names[c], score, left, top, right, bottom)
            labels.append(self.class_names[c]+" "+ str(score)+" "+ str(left)+" "+ str(top)+" "+ str(right)+" "+ str(bottom))
