...
if __name__ == '__main__':
    ...
    plt.ylim([70, 98])
    plt.title("Accuracy of best model without dirty data", fontsize=30 , weight='bold')
    plt.ylabel("Accuracy",fontsize=25)
    plt.xlabel("Epoch",fontsize=25)
    # annot_max(xtrain_acc, ytrain_acc)
    plt.annotate(text, xy=(xtrain_acc, ytrain_acc), xytext=(xtrain_acc+20, ytrain_acc+0.5),arrowprops=dict(facecolor='black',arrowstyle='->'), fontsize=15, weight='bold')
    plt.annotate(str(best_test_acc[424]), xy=(593, best_test_acc[424]), xytext=(593+20, best_test_acc[424]-0.5),arrowprops=dict(facecolor='black',arrowstyle='->'), fontsize=15, weight='bold')
    plt.annotate(str(best_test_acc[524]), xy=(693, best_test_acc[524]), xytext=(693+20, best_test_acc[524]-0.5),arrowprops=dict(facecolor='black',arrowstyle='->'), fontsize=15, weight='bold')
